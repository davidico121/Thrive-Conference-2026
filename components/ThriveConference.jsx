...
export default function ThriveConference() {
  ...
  useEffect(() => {
    if (volunteerSubmitted) {
      document.getElementById('volunteer-confirmation')?.scrollIntoView({ behavior: 'smooth', block: 'center' });
    }
  }, [volunteerSubmitted]);
    ...
    <>
      ...
      <div className="thrive">
        ...
        <div style={{ paddingTop: 68 }}>
          ...
          <section style={{ background: '#170f30', padding: 'clamp(64px, 10vw, 120px) 24px' }}>
            <motion.div style={{ maxWidth: 800, margin: '0 auto' }} variants={stagger} initial="hidden" animate="show">
              ...
              <motion.h1 variants={fadeUp} style={{
                ...
                Discover what it takes to <span style={{ color: '#fecb00' }}>thrive</span> in this AI Era
              </motion.h1>
              ...
              <motion.div variants={fadeUp} style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                <button onClick={scrollToForm} className="t-btn-navy-lg">Secure Your Seat</button>
          ...
          {/* WHY ATTEND */}
          <section style={{ background: '#170f30', padding: 'clamp(64px, 8vw, 96px) 24px' }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
              ...
              <motion.div style={{ display: 'flex', flexDirection: 'column', gap: 0 }} variants={stagger} initial="hidden" whileInView="show" viewport={vp}>
                {[
                  ...
                  <motion.div key={i} variants={fadeUp} style={{ display: 'grid', gridTemplateColumns: '24px 1fr', gap: 20, padding: '28px 0', borderBottom: '1px solid #2c2354' }}>
          ...
          {/* SPEAKERS */}
          <section id="speakers" style={{ background: '#1e1543', padding: 'clamp(64px, 8vw, 96px) 24px' }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
              ...
              {/* Dara */}
              <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={vp} className="t-speaker-card" style={{ marginBottom: 56, paddingBottom: 56, borderBottom: '1px solid #3a2f66' }}>
                <div className="t-speaker-photo">
                  <div style={{ border: '2px solid #fecb00', borderRadius: 4, aspectRatio: '1', overflow: 'hidden' }}>
                ...
                <div>
                  <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 24, color: '#fbf9f6', marginBottom: 4 }}>Dara Sobaloju</h3>
                  <p style={{ fontSize: 12, fontWeight: 600, letterSpacing: '0.07em', textTransform: 'uppercase', color: '#fecb00', marginBottom: 24 }}>Built Pewbeam AI</p>
                  <p style={{ color: '#c9c3e8', lineHeight: 1.75, marginBottom: 16, fontSize: 15 }}>
                  ...
                  <p style={{ color: '#c9c3e8', lineHeight: 1.75, marginBottom: 20, fontSize: 15 }}>
                    <strong style={{ color: '#fbf9f6' }}>Why he's speaking:</strong> Dara's work shows how AI can solve real problems for real communities. He'll walk you through how he thinks about building with AI: how he spots problems worth solving and how he actually ships.
                  </p>
                  <div style={{ borderLeft: '2px solid #a9782f', paddingLeft: 16 }}>
                    <p style={{ color: '#c9c3e8', fontSize: 14, fontStyle: 'italic' }}>
              ...
              <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={vp} className="t-speaker-card">
                ...
                <div>
                  <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 24, color: '#fbf9f6', marginBottom: 4 }}>Micheal Toyinbo</h3>
                  <p style={{ fontSize: 12, fontWeight: 600, letterSpacing: '0.07em', textTransform: 'uppercase', color: '#fecb00', marginBottom: 24 }}>Director of Expansion, Planning & Strategy · Chowdeck</p>
                  <p style={{ color: '#c9c3e8', lineHeight: 1.75, marginBottom: 16, fontSize: 15 }}>
                  ...
                  <p style={{ color: '#c9c3e8', lineHeight: 1.75, marginBottom: 20, fontSize: 15 }}>
                    <strong style={{ color: '#fbf9f6' }}>Why he's speaking:</strong> He's not a futurist talking about what AI could do someday. He's actively using it to drive real growth across multiple markets right now. He'll share what actually moves the needle.
                  </p>
          ...
          <section style={{ background: '#170f30', padding: 'clamp(64px, 8vw, 96px) 24px' }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
              <motion.span variants={fadeUp} initial="hidden" whileInView="show" viewport={vp} className="t-label" style={{ color: '#8b84b5', display: 'block' }}>Programme</motion.span>
              <motion.h2 variants={fadeUp} initial="hidden" whileInView="show" viewport={vp} style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(26px, 4vw, 40px)', color: '#fbf9f6', letterSpacing: '-0.01em', marginBottom: 56 }}>
                What to Expect
              </motion.h2>
              <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={vp}>
              {[
                ...
                <motion.div key={i} variants={fadeUp} style={{ display: 'grid', gridTemplateColumns: '48px 1fr', gap: 24, padding: '28px 0', borderBottom: i < 2 ? '1px solid #2c2354' : 'none' }}>
                  <span style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 12, color: '#fecb00', letterSpacing: '0.06em', paddingTop: 4 }}>{item.n}</span>
                  <div>
                    <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 17, color: '#fbf9f6', marginBottom: 6 }}>{item.title}</h3>
                    <p style={{ color: '#c9c3e8', fontSize: 14, lineHeight: 1.6 }}>{item.desc}</p>
                  </div>
                </motion.div>
              ))}
              </motion.div>
          ...
          {/* READY TO THRIVE CTA */}
          <section style={{ background: '#1e1543', padding: 'clamp(64px, 8vw, 96px) 24px', textAlign: 'center' }}>
            <motion.div style={{ maxWidth: 640, margin: '0 auto' }} variants={stagger} initial="hidden" whileInView="show" viewport={vp}>
              ...
              <motion.h2 variants={fadeUp} style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(28px, 4vw, 48px)', color: '#fbf9f6', letterSpacing: '-0.02em', marginBottom: 20 }}>
                Ready to Thrive?
              </motion.h2>
              <motion.p variants={fadeUp} style={{ fontSize: 17, color: '#c9c3e8', lineHeight: 1.8, marginBottom: 40 }}>
          ...
          {/* JOIN THE TEAM */}
          <section style={{ background: '#241a3f', padding: 'clamp(64px, 8vw, 96px) 24px', borderTop: '2px solid #a9782f', borderBottom: '2px solid #a9782f' }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
              <span className="t-label" style={{ color: '#e0b464' }}>Get Involved</span>
              <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(26px, 4vw, 40px)', color: '#fbf9f6', letterSpacing: '-0.01em', marginBottom: 20 }}>
                Join the Team
              </h2>
          ...
          {/* VOLUNTEER FORM */}
          <section style={{ background: '#170f30', padding: 'clamp(64px, 8vw, 96px) 24px' }} id="volunteer-form">
            <div style={{ maxWidth: 560, margin: '0 auto' }}>
              ...
              {volunteerSubmitted && (
                <div id="volunteer-confirmation" style={{ marginBottom: 32, borderRadius: 4, overflow: 'hidden', textAlign: 'center', border: '2px solid #fecb00' }}>
                  <div style={{ background: '#002626', padding: '18px 32px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
                    <CheckCircle color="#22dcdc" size={22} />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '48px 80px', marginBottom: 56 }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <a href="https://x.com/Thrivebycrum" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#c9c3e8', textDecoration: 'none', fontSize: 14, fontFamily: 'Inter, sans-serif', transition: 'color 0.15s' }}>
                    ...
                    <a href="https://instagram.com/Thrive_initiatives" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#c9c3e8', textDecoration: 'none', fontSize: 14, fontFamily: 'Inter, sans-serif', transition: 'color 0.15s' }}>
                    ...
                    <a href="tel:09064846706" style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#c9c3e8', textDecoration: 'none', fontSize: 14, fontFamily: 'Inter, sans-serif', transition: 'color 0.15s' }}>
